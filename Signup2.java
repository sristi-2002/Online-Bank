...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        l1 = new JLabel("Page 2: Add Your Additonal Details");
        l1.setFont(new Font("Algerian", Font.BOLD, 22));
        
        l2 = new JLabel("Religion:");
        l2.setFont(new Font("Castellar", Font.BOLD, 18));
        ...
        l12.setFont(new Font("Algerian", Font.BOLD, 14));
        
        l13 = new JLabel(formno);
        l13.setFont(new Font("Algerian", Font.BOLD, 13));
